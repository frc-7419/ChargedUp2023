...
public class AutoHighStop extends SequentialCommandGroup {
  ...
  public AutoHighStop(DriveBaseSubsystem driveBaseSubsystem, ElevatorSubsystem elevatorSubsystem, ArmSubsystem armSubsystem, WristSubsystem wristSubsystem, GripperSubsystem gripperSubsystem, GyroSubsystem gyroSubsystem, NodeState scoreLocation, StateMachine stateMachine) {
