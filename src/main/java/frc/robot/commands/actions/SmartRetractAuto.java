...
public class SmartRetractAuto extends SequentialCommandGroup {
  ...
  public SmartRetractAuto(
    ...
    addCommands(
      Commands.parallel(
      new ArmToSetpointWithFeedforward(armSubsystem, NodeState.RESET).raceWith(new WaitCommand(2.5)),
          new WristToSetpointWithFeedforward(wristSubsystem, armSubsystem, NodeState.RESET).raceWith(new WaitCommand(1.5)),
        new ElevatorToSetpointWithFeedForward(elevatorSubsystem, NodeState.RESET).raceWith(new WaitCommand(2.5))));
  }
}
