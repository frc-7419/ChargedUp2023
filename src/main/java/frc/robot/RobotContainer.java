...
public class RobotContainer {
    ...
    private final IntakePiece intakePieceSingleSub = new IntakePiece(elevatorSubsystem, armSubsystem, wristSubsystem,
    ...
    private final IntakePieceDouble intakePieceDoubleSub = new IntakePieceDouble(elevatorSubsystem, armSubsystem,
            wristSubsystem, NodeState.SUBSTATION);
    ...
    private void configureAutoSelector() {
        ...
        autonomousChooser.addOption("Auto High + Balance", new AutoHighBalance(driveBaseSubsystem, elevatorSubsystem,
                armSubsystem, wristSubsystem, gripperSubsystem, gyroSubsystem, NodeState.HIGH));
        autonomousChooser.addOption("Auto Two Piece High", new AutoTwoPieceHigh(driveBaseSubsystem, elevatorSubsystem,
