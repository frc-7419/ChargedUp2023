...
public class ElevatorToSetpointWithFeedForwardIntake extends CommandBase {
  ...
  public ElevatorToSetpointWithFeedForwardIntake(
  ...
  public void initialize() {
    this.desiredPosition = NodeState.valueOf(SmartDashboard.getString("Single Sub State", "GROUND_INTAKE")).elevatorSetpoint;
