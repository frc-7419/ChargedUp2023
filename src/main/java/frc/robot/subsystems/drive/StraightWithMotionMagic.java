...
public class StraightWithMotionMagic extends CommandBase {
  ...
  public void initialize() {
    ...
    TalonFuncs.setPIDFConstants(
        0,
        driveBaseSubsystem.getLeftMast(),
        PIDConstants.DriveBaseMotionMagickP,
        PIDConstants.DriveBaseMotionMagickI,
        PIDConstants.DriveBaseMotionMagickD,
        0);
    TalonFuncs.setPIDFConstants(
        0,
        driveBaseSubsystem.getRightMast(),
        PIDConstants.DriveBaseMotionMagickP,
        PIDConstants.DriveBaseMotionMagickI,
        PIDConstants.DriveBaseMotionMagickD,
        0);
