...
public class WristToSetpointWithFeedForwardIntake extends CommandBase {
  ...
  public WristToSetpointWithFeedForwardIntake(
      WristSubsystem wristSubsystem, ArmSubsystem armSubsystem) {
  ...
  public void initialize() {
    this.setpoint = NodeState.valueOf(SmartDashboard.getString("Single Sub State", "GROUND_INTAKE")).wristSetpoint;
